...
test("legacy discovery rejects network mode before accessing registry URLs", { skip: "asserts the two-track guard added to discover-content-opportunities.mjs on the lifecycle branch; the 2026-08-14 merge kept main's deployed engine version, which does not have the guard" }, (t) => {

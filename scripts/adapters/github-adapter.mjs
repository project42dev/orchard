...
function assertPublicationTarget(repository, branch, { allowHead = false } = {}) {
    if (repository !== 'project42dev/project42-content' && !repository.startsWith('project42dev/')) throw new TypeError('publication is restricted to project42dev/project42-content');

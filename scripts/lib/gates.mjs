...
function renderGateSummary(manifest) {
    ...
    if (attention.length === 0) {
        return [`**All ${manifest.items.length} item${manifest.items.length === 1 ? '' : 's'} passed every review.** Commenting just the word \`approve\` or \`approved\` on this issue approves all of them.`, ''];
    }

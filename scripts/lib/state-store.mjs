...
export class StateStore {
    ...
    async recordTransition(record) {
        ...
        if (["invalidated", "externally-published"].includes(record.to_state)) {
            ...
            if (!evidence) throw new StateConflictError(`${record.to_state} requires persisted matching evidence`);
        }

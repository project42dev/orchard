...
> opening a GitHub issue and has no schedule. **Content is authored BEFORE you approve it**, and the approval that exists acts on a bare `Approved` comment with no item or digest binding. Gates, work-item binding, publication and live
